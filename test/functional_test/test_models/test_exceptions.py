...
class TestExceptionFunctional(unittest.TestCase):
    ...
    def test_raise_missing_permission_exception(self):
    ...
    def test_raise_operation_not_permitted_exception(self):
    ...
    def test_raise_unexpected_extension_exception(self):
    ...
    def test_raise_expected_extensions_missing_exception(self):
    ...
    def test_raise_stac_validation_exception(self):
    ...
    def test_raise_authorization_exception(self):
    ...
    def test_raise_item_already_exists_exception(self):
    ...
    def test_raise_item_does_not_exist_exception(self):
    ...
    def test_raise_unknown_exception(self):
